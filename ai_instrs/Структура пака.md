...
- [Формирование черновиков](<../../ai_drafts/ai_instrs/Формирование черновиков.md>)
...
**На основе:**
- [Концепт](</ai_instrs.concept/Состав пака/_.md#контекст-инструкций>)
- [Проактивный сбор контекста](</ai_instrs.concept/Состав пака/_.md#проактивный-сбор-контекста>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#выполнение-инструкций>)

В него входит:
- [Инкрементальное обновление результата](</ai_instrs.concept/Состав пака/_.md#инкрементальное-обновление-результата>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#структура-файлов-и-рабочее-пространство>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#формирование-промптов>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#реверс-инжиниринг>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#рефакторинг-инструкций>)

На основе:
- [структуры файлов](</ai_instrs.concept/Состав пака/_.md#структура-файлов-и-рабочее-пространство>)
- [Изоляция контекста](</ai_instrs.concept/Общие/Изоляция контекста.md>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#одновременное-обновление-инструкций-и-результата>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#дебаг-и-обратная-связь>)
...
[Концепт](</ai_instrs.concept/Состав пака/_.md#мета-инструкции>)
