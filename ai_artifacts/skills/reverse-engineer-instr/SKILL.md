...
description: "НЕ АКТИВИРОВАТЬ АВТОМАТИЧЕСКИ. Workflow только для явного вызова через слэш-команду. Перевод существующей реализации или артефактов обратно в строгие ИИ-инструкции."
---
