...
* Проверьте и оптимизируйте сеть гиперссылок между инструкциями для обеспечения графовой навигации.
* Убедитесь, что все относительные пути корректны и не выходят за границы рабочей директории.

### 3. Изоляция контекста
* **Контекстное разделение**: При рефакторинге выявляйте инструкции, где смешаны разнородные сложные задачи (вызывающие загрязнение контекста). Разделяйте их на отдельные, строго сфокусированные файлы инструкций.
* **Избегайте механического дробления**: Не разделяйте простые подзадачи без необходимости; разделяйте только тогда, когда подробные шаги одной задачи отвлекают от другой, требуя их выполнения в чистых, раздельных контекстах.
