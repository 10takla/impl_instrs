...
description: "ВЫЗЫВАЕТСЯ ИСКЛЮЧИТЕЛЬНО ПОЛЬЗОВАТЕЛЕМ (ОПЕРАТОРОМ) ВРУЧНУЮ. Запрещено автоматическое фоновое срабатывание. Перевод существующей реализации (кода, архитектуры, артефактов) обратно в формат строгих инструкций для ИИ-агентов."
---
...
2. **ОБЯЗАТЕЛЬНО**: при формировании ссылок между файлами инструкций строго соблюдайте синтаксис: пути в ссылках `[]()` должны быть обернуты in угловые скобки `(<путь>)` (пример: `[Модуль](<./module.md>)`).
